...
class RoatingView extends StatefulWidget {
  final String _path;

  RoatingView(this._path);

  @override
  State<StatefulWidget> createState() => _RoatingViewState();
}
...
class _RoatingViewState extends State<RoatingView>
...
//    }
  ...
  @override
  void didUpdateWidget(RoatingView oldWidget) {
    WidgetsBinding.instance.addPostFrameCallback(_onAfterRendering);
